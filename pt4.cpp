...
//  for Microsoft Visual C++ 2008                   //
//                                                  //
//            Copyright (C) M.E.Abramyan, 2006-2015 //
//--------------------------------------------------//
...
{
   DWORD dw;
   dw=(*(*e).ExceptionRecord).ExceptionCode;
...
void ShowLine(string s, int a)
{
  Show(s.c_str(), a, 0); Show("\n");
}
...
void ShowLine(string s, double a)
{
  Show(s.c_str(), a, 0); Show("\n");
}
